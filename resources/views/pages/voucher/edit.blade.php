						...
						<form action="/voucher/{{ $voucher->slug }}" method="POST">
							...
							<div class="row">
								...
								<div class="col-12 col-md-6 mb-3">
									...
									<div class="input-group mb-2">
										<input type="text" class="form-control @error('discount') is-invalid @enderror" name="discount"
											placeholder="Discount" value="{{ $voucher->discount }}">
								...
								<div class="col-12 col-md-6 mb-3">
									...
									<input id="start" type="date" value="{{ $voucher->start }}" class="form-control" placeholder="Start"
										name="start" />
									@error('start')
										<div class="invalid-feedback">{{ $message }}</div>
									@enderror
								...
								<div class="col-12 col-md-6 mb-3">
									...
									<input id="end" type="date" value="{{ $voucher->end }}" class="form-control" placeholder="End"
										name="end" />
									@error('end')
										<div class="invalid-feedback">{{ $message }}</div>
									@enderror
