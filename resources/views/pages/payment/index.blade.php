			...
			<div class="card">
				@if($role == 'admin')
					<div class="card-header">
						<div class="col-2">
							<a href="/payments/create" class="btn btn-primary w-100">
										...
										@if($role == 'admin')
											<td>
												<div class="row">
													...
													<div class="col-6 col-sm-4 col-md-2 col-xl-auto">
														<a href="payments/{{ $outlet->slug }}/edit" class="btn btn-outline-warning w-50 btn-icon" title="Edit">
															<svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
																stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
																<path stroke="none" d="M0 0h24v24H0z" fill="none" />
													...
													<div class="row">
														...
														<div class="col-12 col-md-6 mb-3">
															...
															<textarea class="form-control" id="description" cols="30" rows="10"
																readonly>{{ $outlet->description }}</textarea>
														</div>
													</div>
												</div>
											</div>
