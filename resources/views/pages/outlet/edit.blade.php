      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <div class="col-2">
              <a href="/outlet" class="btn btn-warning w-100">
            ...
            <form action="/outlet/{{ $outlet->slug }}" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 mb-3">
                  ...
                  <textarea class="form-control @error('address') is-invalid @enderror" name="address" cols="30"
                    rows="10">{{ $outlet->address }}</textarea>
                    @error('address')
                  <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
